 ...
 *
 */
    	$target_path = '/Applications/MAMP/htdocs/images/products/' . $img_name;
 ...
 */
	// for the large (regular) images
    	$current_path = '/Applications/MAMP/htdocs/images/tmp/'      . $img_name;
  	$new_path     = '/Applications/MAMP/htdocs/images/products/' . $img_name;

	rename($current_path, $new_path);


	// for the thumbsnails
	$current_path = '/Applications/MAMP/htdocs/images/tmp/thumbs/'      . $img_name;
	$new_path     = '/Applications/MAMP/htdocs/images/products/thumbs/' . $img_name;
